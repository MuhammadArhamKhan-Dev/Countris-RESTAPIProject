...
const CountryDetail = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://restcountries.com/v5/name/${countryName}?fullText=true&fields=name,flags,region,population,capital,subregion,tld,currencies,languages,borders`,
            {
                headers: {
